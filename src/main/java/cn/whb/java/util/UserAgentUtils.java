...
public class UserAgentUtils {
    ...
    public static String getThirdSource(String page){
        if (StringUtils.isNotBlank(page)){
            if(page.contains("zhuzhanapp")){
                return "APP分享";
            }else if(page.contains("zhuzhan")){
                return "PC网站";

            }else{
                if(page.contains("third")){
                    if(page.contains("jinri")){
                        return "今日头条";
                    }else if(page.contains("uc")){
                        return "UC头条";
                    }else if(page.contains("yidian")){
                        return "一点资讯";
                    }else if(page.contains("zaker")){
                        return "ZAKER新闻";
                    }else{
                        return null;
                    }
                }else if(page.contains("app")){
                    return "APP";
                }
                else{
                    return "other";

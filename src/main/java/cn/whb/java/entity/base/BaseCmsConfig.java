...
import cn.whb.java.entity.CmsConfigItem;
...
public abstract class BaseCmsConfig  implements Serializable {
    ...
    public boolean equals (Object obj) {
        ...
        if (!(obj instanceof cn.whb.java.entity.CmsConfig)) return false;
        else {
            cn.whb.java.entity.CmsConfig cmsConfig = (cn.whb.java.entity.CmsConfig) obj;

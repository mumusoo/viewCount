...
public abstract class BaseContentCount  implements Serializable {
    ...
    private Integer viewsPc;
    private Integer viewsApp;
    private Integer viewsJinri;
    private Integer viewsYidian;
    private Integer viewsUc;
    private Integer viewsZaker;
    private Integer viewsAppShare;
    private Integer viewsOther;

    // one to one
    private cn.whb.java.entity.Content content;
     ...
     */
    public cn.whb.java.entity.Content getContent () {
        return content;
    }
     ...
     */
    public void setContent (cn.whb.java.entity.Content content) {
        this.content = content;
    }



    public Integer getViewsPc() {
        return viewsPc;
    }

    public void setViewsPc(Integer viewsPc) {
        this.viewsPc = viewsPc;
    }

    public Integer getViewsApp() {
        return viewsApp;
    }

    public void setViewsApp(Integer viewsApp) {
        this.viewsApp = viewsApp;
    }

    public Integer getViewsJinri() {
        return viewsJinri;
    }

    public void setViewsJinri(Integer viewsJinri) {
        this.viewsJinri = viewsJinri;
    }

    public Integer getViewsYidian() {
        return viewsYidian;
    }

    public void setViewsYidian(Integer viewsYidian) {
        this.viewsYidian = viewsYidian;
    }

    public Integer getViewsUc() {
        return viewsUc;
    }

    public void setViewsUc(Integer viewsUc) {
        this.viewsUc = viewsUc;
    }

    public Integer getViewsZaker() {
        return viewsZaker;
    }

    public void setViewsZaker(Integer viewsZaker) {
        this.viewsZaker = viewsZaker;
    }

    public Integer getViewsAppShare() {
        return viewsAppShare;
    }

    public void setViewsAppShare(Integer viewsAppShare) {
        this.viewsAppShare = viewsAppShare;
    }

    public Integer getViewsOther() {
        return viewsOther;
    }

    public void setViewsOther(Integer viewsOther) {
        this.viewsOther = viewsOther;
    }

    public boolean equals (Object obj) {
        if (null == obj) return false;
        if (!(obj instanceof cn.whb.java.entity.ContentCount)) return false;
        else {
            cn.whb.java.entity.ContentCount contentCount = (cn.whb.java.entity.ContentCount) obj;

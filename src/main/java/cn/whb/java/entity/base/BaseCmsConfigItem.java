...
public abstract class BaseCmsConfigItem  implements Serializable {
    ...
    public BaseCmsConfigItem (
            ...
            cn.whb.java.entity.CmsConfig config,
    ...
    // many to one
    private cn.whb.java.entity.CmsConfig config;
     ...
     */
    public cn.whb.java.entity.CmsConfig getConfig () {
        return config;
    }
     ...
     */
    public void setConfig (cn.whb.java.entity.CmsConfig config) {
        this.config = config;
    }
    ...
    public boolean equals (Object obj) {
        ...
        if (!(obj instanceof cn.whb.java.entity.CmsConfigItem)) return false;
        else {
            cn.whb.java.entity.CmsConfigItem cmsConfigItem = (cn.whb.java.entity.CmsConfigItem) obj;
